...
// this page is under construction, we will return soon with the payment page for the invoice.
import React from 'react'

export default function page() {
  return (
    <div className='min-h-[80vh] flex items-center justify-center'>
      <h1 className='text-2xl font-semibold'>Payment page is under construction, we will return soon.</h1>
    </div>  
  )
}
