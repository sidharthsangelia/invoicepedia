...
import { Loader2, Plus, Trash2, FileText, ChevronDown } from "lucide-react";
...
export function InvoiceForm() {
  ...
  async function onSubmit(values: InvoiceFormValues) {
    ...
    // Line items — server action expects lineItems[N][field] keys
    ...
    // redirect() inside the action throws NEXT_REDIRECT — that's success,
    // so we only land here on actual errors.
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          <span className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-sm text-muted-foreground">
                            {watchedCurrency === "EUR" ? "€" : watchedCurrency === "GBP" ? "£" : watchedCurrency === "INR" ? "₹" : "$"}
                          </span>
                          <Input
                            {...f}
                            type="number"
